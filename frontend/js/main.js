...
(function() {
  ...
  /**
   * Initialize optional features when DOM is ready
   */
  window.addEventListener('load', function() {
    // Only initialize if elements exist in the current view
  ...
  /**
   * Expose AOS refresh for router to call after loading new views
   */
